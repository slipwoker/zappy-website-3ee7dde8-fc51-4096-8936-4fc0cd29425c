    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Noam Med-Defense משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3ee7dde8-fc51-4096-8936-4fc0cd29425c',
                    name: data.name || '',
                    email: data.email || '',
